...
*現代化深色模式介面與高效搜尋結果展示，具備可隨時喚起的 AI Agent 側邊欄*

![AI Agent 功能](imgs/demo_agent.png)
*整合 LangGraph 與 MCP Server，支援 SSE 串流對話、工具呼叫與思考過程透明化*

![貼文詳情彈窗](imgs/demo_detail.png)
*全新實作的大圖模式彈窗，採用 1:3 黃金比例，支援雙欄圖片展示與完整內文閱讀*

![Elasticsearch 整合](imgs/demo_es.png)
*基於 Elasticsearch 的強大全文檢索後端，支援毫秒級搜尋與精確排序*
...
- **🖼️ 貼文詳情彈窗 (Detail Modal)**:
  - **1:3 黃金比例**: 提供超寬版面，確保圖片與文字都有極佳的展示空間。
  - **大圖網格設計**: 支援雙欄圖片展示，讓多圖貼文一目了然。
  - **沉浸式體驗**: 具備模糊背景與平滑縮放動畫。
...
- **深入細節**：點擊任一搜尋結果卡片，會開啟 **「大圖詳情彈窗」**，查看完整內容與多張美照。
